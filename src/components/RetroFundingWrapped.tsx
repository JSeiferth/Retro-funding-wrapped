...
const RetroFundingWrapped: React.FC<RetroFundingWrappedProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="fixed bottom-16 left-0 w-full flex justify-between items-center px-4 sm:px-8 z-20">
        <button
          onClick={prevSlide}
      ...
      {/* Instructions */}
      <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 text-white/60 text-xs text-center z-20">
